...
\begin{tabular}{lcl}
\centering
\adj{\includegraphics[width=0.62in]{imagenes/umss}}  & \adj{\includegraphics[width=4.1in]{imagenes/texto}} & \adj{\includegraphics[width=0.72in]{imagenes/fcyt}}  
\end{tabular}
\end{center}
\end{table}

% \vspace{3cm} % University name
