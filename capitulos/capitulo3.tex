...
La ventaja de aplicar PCA al conjunto de datos es la simplificaci\'{o}n de la complejidad del mismo, as\'{i} como tambi\'{e}n la conservaci\'{o}n de gran parte de su informaci\'{o}n, por lo cual en este estudio se pudo reducir de 6 caracter\'{i}sticas a tan s\'{o}lo 3, es decir se redujo a la mitad, perdiendo s\'{o}lo aproximadamente un 8\% de la varianza del conjunto de datos.
