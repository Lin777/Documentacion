...
\begin{figure}[h!]
  \begin{center}	\includegraphics[width=0.6\textwidth]{imagenes/Cap2/anom_contx}
...
\begin{figure}[h!]
  \begin{center}	\includegraphics[width=0.45\textwidth]{imagenes/Cap2/anom_col}
