...
\begin{figure}[h!]
  ...
  \caption{Anomal\'{i}a contextual $t_2$ en una serie temporal de temperatura \protect\cite{Reference66}.}
...
\begin{figure}[h!]
  ...
  \caption{Anomalía colectiva correspondiente a una contracción prematura auricular en un electrocardiograma humano \protect\cite{Reference66}.}
  \label{fig:anom_col}
  \end{center}
\end{figure}
